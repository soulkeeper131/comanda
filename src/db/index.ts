...
// Идемпотентно — следващите стартове са no-op.
...
// Паролите идват от env (SEED_ADMIN_PASSWORD и т.н.), иначе падат на dev defaults.
// Идемпотентно — ако вече има потребители, нищо не прави.
try {
