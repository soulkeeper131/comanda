  ...
  return (
    <>
      ...
      <section className="l-sec">
        <div className="l-wrap">
          <div className="l-eyebrow">Процес</div>
          <h2 className="l-h2">
            Как работи Ко Манда
            <br />
            стъпка по стъпка
          ...
          <div className="l-flow">
            {[
              ["1", "📩", "Запитване", "Собственикът описва имота и какво му трябва. Получава оферта до 24 часа."],
              ["2", "🏠", "Регистрация на имот", "Създаваме профил на имота с адрес, локация и собственик."],
              ["3", "📋", "Възлагане на обход", "Администраторът избира шаблон, изпълнител и дата за първия обход."],
              ["4", "🔧", "Изпълнение", "Работникът отива на място, отключва чек-листа с GPS и минава точка по точка със снимки."],
              ["5", "⚠️", "Констатация", "При проблем — снима се, описва се и се изпраща веднага към собственика."],
              ["6", "💰", "Оферта", "Администраторът изготвя оферта с цена, срок и обхват на ремонта."],
              ["7", "✅", "Решение", "Собственикът приема или отказва офертата директно от телефона си. При приемане — организираме майстора."],
      ...
      <section className="l-sec" id="packages">
        <div className="l-wrap">
          ...
          <div className="l-pkgs">
            {[
              ["🔨", "Присъствие при майстор", "Водопроводчик, електротехник, техник на асансьора, застрахователен оглед. Някой трябва да е там и да отчете какво е свършено.", "20", "€ / до 2 часа"],
              ["🚨", "Извънредна проверка", "След буря, сигнал от съсед, спиране на тока или просто лошо предчувствие. Отиваме до 6 часа и пращаме снимки.", "25", "€ / посещение"],
              ["🧰", "Зимна консервация", "Еднократна подготовка преди дълго отсъствие — спиране на вода, източване на инсталацията, режим на отоплението.", "75", "€ еднократно"],
              ["📦", "Приемане на доставка", "Мебел, техника, пратка с подпис. Приемаме, проверяваме за щети и снимаме опаковката преди и след отваряне.", "15", "€ / доставка"],
              ["🧹", "Почистване", "Поливане, косене на тревата, разчистване на листа. Добавя се към обхода или се заявява отделно.", "80", "€ / посещение"],
              ["📑", "Фотоотчет за трета страна", "Пълен снимков протокол за застраховател, банка, купувач или при спор със съсед. С дата, час и координати.", "20", "€ / протокол"],
              ["🔧", "Ремонт по оферта", "Открием ли нещо при обход, получаваш цена, срок и обхват в писмен вид. Организираме майстора. Решаваш ти.", "по", "оферта"],
              ["✎", "Твоя услуга", "Нещо, което не е в списъка? Опиши какво ти трябва в запитването — връщаме цена и срок до 24 часа. Ако е изпълнимо, го правим.", "по", "заявка"],
            ].map(([icon, title, desc, price, unit], i) => (
              <div
                key={title}
                className="l-pkg"
                style={
