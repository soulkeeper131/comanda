    ...
    <>
      ...
      <nav className="l-nav">
        <div className="l-wrap">
          ...
          <Link href="/login" className="l-btn l-btn-g" style={{ padding: "10px 18px", fontSize: "14.5px", minHeight: 44, display: "inline-flex", alignItems: "center" }}>
            Вход
          </Link>
          <Link href="/register" className="l-btn l-btn-p" style={{ padding: "10px 18px", fontSize: "14.5px", minHeight: 44, display: "inline-flex", alignItems: "center" }}>
            Регистрация
          </Link>
        </div>
      </nav>
      ...
      <section className="l-sec" id="packages">
        <div className="l-wrap">
          ...
          <p className="l-lead">
            Всеки абонамент е фиксиран чек-лист. Няма „минахме, всичко беше наред&rdquo; —
      ...
      <section className="l-sec l-sec-alt" id="repairs">
        <div className="l-wrap">
          ...
          <p className="l-lead">
            Констатацията не отива в графа „други бележки&rdquo;. Тръгва процес,
