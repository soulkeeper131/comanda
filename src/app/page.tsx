    ...
    <>
      ...
      <nav className="l-nav">
        <div className="l-wrap">
          <div className="brand">
            <div className="dot">◉</div>Ко Манда
          </div>
      ...
      <section className="l-sec l-sec-alt" id="why">
        <div className="l-wrap">
          ...
          <div className="l-risks">
            ...
            <div className="l-risk">
              <div className="ic">👁️</div>
              <h4>Личи си, че е празно</h4>
              <p>
                Препълнена пощенска кутия и вечно тъмни прозорци са покана.
                Редовното присъствие е най-евтината охрана.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="l-sec" id="packages">
        <div className="l-wrap">
          ...
          <div className="l-pkgs">
            {[
              ["🔨", "Присъствие при майстор", "Водопроводчик, електротехник, техник на асансьора, застрахователен оглед. Някой трябва да е там и да отчете какво е свършено.", "35", "лв / до 2 часа"],
              ["🚨", "Извънредна проверка", "След буря, сигнал от съсед, спиране на тока или просто лошо предчувствие. Отиваме до 6 часа и пращаме снимки.", "45", "лв / посещение"],
              ["🧰", "Зимна консервация", "Еднократна подготовка преди дълго отсъствие — спиране на вода, източване на инсталацията, режим на отоплението.", "140", "лв еднократно"],
              ["📦", "Приемане на доставка", "Мебел, техника, пратка с подпис. Приемаме, проверяваме за щети и снимаме опаковката преди и след отваряне.", "30", "лв / доставка"],
              ["🪴", "Растения и двор", "Поливане, косене на тревата, разчистване на листа. Добавя се към обхода или се заявява отделно.", "25", "лв / посещение"],
              ["📑", "Фотоотчет за трета страна", "Пълен снимков протокол за застраховател, банка, купувач или при спор със съсед. С дата, час и координати.", "70", "лв / протокол"],
      ...
      <section className="l-sec" id="proof">
        <div className="l-wrap">
          ...
          <p className="l-lead">
            Ти си на 1500 км. Всеки може да ти каже, че е минал.
